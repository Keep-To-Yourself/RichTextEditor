...
public class RichTextEditor: UIView {
    ...
    var textView: TextEditor!
    var configuration: RichTextEditorConfiguration
    public var onFocusChanged: ((Bool) -> Void)?
    
    public init(configuration: RichTextEditorConfiguration, document: Document? = nil) {
        self.configuration = configuration
        super.init(frame: .zero)
        
        var doc = document ?? Document()
        if document == nil {
            doc.blocks[UUID()] = .list(content: ListContent(document: doc, parentID: nil, items: [
                .text(content: [
                    InlineTextFragment(
                        text: "项目一\n",
                        isBold: false,
            ...
            doc.blocks[UUID()] = .heading(level: 1, content: [
                InlineTextFragment(
                    text: "标题\n",
                    isBold: true,
                    isItalic: false,
            ...
            doc.blocks[UUID()] = .paragraph(content: [
                InlineTextFragment(
                    text: "正文内容\n",
                    isBold: false,
                    isItalic: true,
            ...
            let blockquoteContent = BlockquoteContent(document: doc, parentID: nil, items: [
                .text(content: [
                    InlineTextFragment(
                        text: "引用内容\n",
                        isBold: false,
            ...
            let blockquoteContentSubList = BlockquoteContent(document: doc,parentID: blockquoteContent.id, items: [
                .text(content: [
                    InlineTextFragment(
                        text: "引用+列表\n",
                        isBold: false,
            ...
            let listContent = ListContent(document: doc, parentID: nil, items: [
                .text(content: [
                    InlineTextFragment(
                        text: "列表内容\n",
                        isBold: false,
            ...
            let listContentSubList = ListContent(document: doc, parentID: listContent.id, items: [
                .text(content: [
                    InlineTextFragment(
                        text: "嵌套列表\n",
                        isBold: false,
